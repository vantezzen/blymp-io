  ...
  <div>
    ...
    {transfer.isSender ? (
      <Section>
        ...
        <div className="file-input">
          <input
            ...
            onChange={(event) => {
              ...
              debug(
                "Setting newly created Provider as current upload provider"
              );
        ...
        {transfer.uploadProvider &&
          transfer.uploadProvider.getNumberOfFiles() > 0 && (
            <div className="file-info">
              {transfer.uploadProvider.getNumberOfFiles()} file(s) fill be
              uploaded
            </div>
          )}
      ...
      <Section>
        <Sync rotate color="#FFFFFF" fontSize="50" />
        <h2>
