...
const Connecting = () => (
  <>
    ...
    <div>
      <p>Last updated:&nbsp;03/15/2020</p>
      <ol>
        <li><strong><u>Introduction</u></strong></li>
      </ol>
      <p>
        Welcome to&nbsp;
        <strong>blymp.io</strong>
&nbsp;(&ldquo;
        ...
        &ldquo;
        <strong>us</strong>
        &rdquo;)! As you have just clicked to our Terms of Service, please make a
        pause, grab a cup of coffee and carefully read the following pages. It will take you approximately
        20&nbsp;minutes.
      </p>
      <p>
        ...
        &rdquo;) govern your use of&nbsp;our web pages located at http://blymp.io and
        our mobile application&nbsp;blymp.io (together or individually
        &ldquo;
        <strong>Service</strong>
        &rdquo;)&nbsp;operated by&nbsp;blymp.io.
      </p>
      <p>
        ...
        https://blymp.io/pp.html.
      </p>
      <p>
        Your agreement with us includes these Terms&nbsp;and our Privacy
        Policy&nbsp;(&ldquo;
        <strong>Agreements</strong>
        &rdquo;). You acknowledge that you have read and
      ...
      <p>
        ...
        please let us know by emailing at properly+blymp@pm.me so we can try to find a solution. These Terms
      ...
      <p>
        ...
        &rdquo;) made available through Service may be governed by rules
      ...
      <p>
        blymp.io, in its sole discretion and at any time, may modify Subscription fees for the
        Subscriptions. Any Subscription fee change will become effective at the end of the then-current
        Billing Cycle.
      </p>
      <p>
        blymp.io&nbsp;will provide you with a reasonable prior notice of any change in Subscription fees
      ...
      <p>
        ...
        text, graphics, videos, or other material (&ldquo;
        <strong>Content</strong>
        &rdquo;). You are
        responsible for Content that you post on or through Service, including its legality, reliability,
        and appropriateness.
      </p>
      <p>
      ...
      <p>
        blymp.io&nbsp;has the right but not the obligation to monitor and edit all Content provided by
        users.
      </p>
      <p>
        In addition, Content found on or through this Service are the property of&nbsp;blymp.io&nbsp;or
      ...
      <ul>
        ...
        <li>
          ...
          &ldquo;junk mail&rdquo;, &ldquo;chain letter,&rdquo; &ldquo;spam,&rdquo; or any other similar
          solicitation.
        </li>
        <li>
        ...
        <li>
          To engage in any other conduct that restricts or inhibits anyone&rsquo;s use or enjoyment of
      ...
      <ul>
        <li>
          ...
          with any other party&rsquo;s use of Service, including their ability to engage in real time
      ...
      <p>
        ...
        accessing or using any of Company, you warrant and represent that you are at least eighteen (18)
      ...
      <p>
        ...
        are and will remain the exclusive property of&nbsp;blymp.io&nbsp;and its licensors. Service is
        protected by copyright, trademark, and other laws of&nbsp;foreign countries. Our trademarks and
      ...
      <p>
        ...
        email to&nbsp;properly+blymp@pm.me, with the subject line: &ldquo;Copyright Infringement&rdquo; and
      ...
      <p>
        You may provide us&nbsp;directly at properly+blymp@pm.me&nbsp;with information and feedback
        concerning errors, suggestions for improvements, ideas, problems, complaints, and other matters
        related to our Service (&ldquo;
        <strong>Feedback</strong>
        &rdquo;). You acknowledge and agree that:
      ...
      <p>
        blymp.io&nbsp;has no control over, and assumes no responsibility for the content, privacy
      ...
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT&nbsp;blymp.io&nbsp;SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR
      ...
      <p>
        THESE SERVICES ARE PROVIDED BY COMPANY ON AN &ldquo;AS IS&rdquo; AND &ldquo;AS AVAILABLE&rdquo;
        BASIS. COMPANY MAKES NO REPRESENTATIONS OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE
        OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT OR MATERIALS INCLUDED THEREIN. YOU
        EXPRESSLY AGREE THAT YOUR USE OF THESE SERVICES, THEIR CONTENT, AND ANY SERVICES OR ITEMS OBTAINED
      ...
      <p>By email: properly+blymp@pm.me.</p>
    </div>
  </>
);
