    ...
    <div className="legal-text">
      ...
      <div>
        ...
        <p>
          ...
          &rdquo;, &ldquo;
          <strong>us</strong>
          &rdquo;)! As you have just clicked to our Terms of Service, please
          make a pause, grab a cup of coffee and carefully read the following
        ...
        <p>
          ...
          http://blymp.io and our mobile application&nbsp;blymp.io (together or
          individually &ldquo;
        ...
        <p>
          ...
          properly+blymp@pm.me so we can try to find a solution. These Terms
        ...
        <p>
          ...
          properly+blymp@pm.me.
        </p>
        <ol start={3}>
          <li>
            <strong>
              <u>Contests, Sweepstakes and Promotions</u>
            </strong>
          </li>
        </ol>
        <p>
          Any contests, sweepstakes or other promotions (collectively, &ldquo;
          <strong>Promotions</strong>
          &rdquo;) made available through Service may be governed by rules that
          are separate from these Terms of Service. If you participate in any
        ...
        <p>
          blymp.io, in its sole discretion and at any time, may modify
        ...
        <p>
          blymp.io&nbsp;will provide you with a reasonable prior notice of any
        ...
        <p>
          ...
          &rdquo;). You are responsible for Content that you post on or through
        ...
        <p>
          blymp.io&nbsp;has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of&nbsp;blymp.io&nbsp;or used with permission. You may not distribute,
        ...
        <p>
          ...
          property of&nbsp;blymp.io&nbsp;and its licensors. Service is protected
          by copyright, trademark, and other laws of&nbsp;foreign countries. Our
          trademarks and trade dress may not be used in connection with any
          product or service without the prior written consent of&nbsp;blymp.io.
        </p>
        <ol start={12}>
          <li>
            <strong>
              <u>Copyright Policy</u>
            </strong>
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          to&nbsp;properly+blymp@pm.me, with the subject line: &ldquo;Copyright
        ...
        <ol start={13}>
          <li>
            <strong>
              <u>DMCA Notice and Procedure for Copyright Infringement Claims</u>
            </strong>
          </li>
        </ol>
        <p>
        ...
        <p>
          ...
          at&nbsp;properly+blymp@pm.me
        </p>
        <ol start={14}>
          <li>
            <strong>
              <u>Error Reporting and Feedback</u>
            </strong>
          </li>
        </ol>
        <p>
          You may provide us&nbsp;directly at properly+blymp@pm.me&nbsp;with
          ...
          to our Service (&ldquo;
          <strong>Feedback</strong>
          &rdquo;). You acknowledge and agree that: (i) you shall not retain,
        ...
        <p>
          ...
          that are not owned or controlled by&nbsp;blymp.io
        </p>
        <p>
          blymp.io&nbsp;has no control over, and assumes no responsibility for
          the content, privacy policies, or practices of any third party web
          sites or services. We do not warrant the offerings of any of these
          entities/individuals or their websites.
        </p>
        <p>
          YOU ACKNOWLEDGE AND AGREE THAT&nbsp;blymp.io&nbsp;SHALL NOT BE
        ...
        <p>
          ...
          laws of&nbsp;Germany&nbsp;without regard to its conflict of law
          provisions.
        </p>
        <p>
