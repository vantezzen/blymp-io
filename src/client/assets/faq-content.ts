  ...
  rows: [
    {
      ...
      content:
        'blymp.io can be used for free because of its underlying architecture:<br />blymp.io tries to transfer files using a peer-to-peer connection, meaning no server needs to be used. Due to this, the hosting for blymp.io is fairly cheap for me, so I can also offer it for free.<br /><br />Even though its free, blymp.io does not save or sell your data!<br /><br />If you\'d like to support blymp.io and help keep the service running, please consider donating:<br /><br /><a href="https://www.buymeacoffee.com/vantezzen" target="_blank" rel=\'noopener\'><img src="' +
        bmcLogo +
        '" alt="Buy Me A Coffee" width="150" /></a>',
    },
    {
      title: "How fast will the files be transferred?",
      content:
        "Transfer speeds depend on a lot of factors, e.g. if your devices are in the same network, your internet speed, whether we can use Peer-to-peer technologies and many more. This is why we can't give an exact transfer speed but we will calculate an estimate time remaining while you transfer a file.<br />Generally, you should always try to keep your devices in the same network and use modern browsers like Chrome to achieve the best possible transfer speeds.",
    },
    {
      title: "What browsers are supported by blymp.io?",
      content:
        "blymp.io is compatible with all modern browsers, including Chrome, Firefox, Edge, Safari, Opera and many more. However, we do not support Internet Explorer and Opera Mini as these browsers do not support the technologies we use to transfer files.",
    },
    {
      title: "How many files can I transfer? How large can the files be?",
      content:
        "blymp.io allows you to transfer an unlimited amount of files - we don't limit the number of files you can select!<br /><br />The maximum file size a single file can have depends on factors with the receiving device so we can't give an exact amount but we already successfully transferred files with a size of multiple Gigabytes. During transfer, these files will be loaded into your computer's memory on both devices, so file sizes might be limited by that.",
    },
    {
    ...
    },
    {
      ...
      content:
        "blymp.io's complete source code is open source and can be seen at <a href='https://github.com/vantezzen/blymp-io'>https://github.com/vantezzen/blymp-io</a>",
    },
    {
      title: "Can I contribute to blymp.io?",
      content:
        "Yes, contributors are always welcome! If you have some experience with JavaScript and ReactJS - of if you want to learn them -, you can dive right into the code at <a href='https://github.com/vantezzen/blymp-io'>https://github.com/vantezzen/blymp-io</a>. You can simply test your changes locally and create a pull request once you're done.",
    },
  ],
};
